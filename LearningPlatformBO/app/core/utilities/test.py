...
class AbstractModelTestCase(TestCase):
    ...
    Usage: use this class as the certifications class, and set the class variable MODELS to a list of concrete models generated
    from the abstract class under certifications. For example, to certifications `MyAbstractModel`:
